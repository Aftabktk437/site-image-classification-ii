...
# Filtering and selecting top 5 high-resolution images
base_folder = "output"

# Initialize a list to hold image information (file path and resolution)
images_info = []

# Iterate through each category folder except "Building" and "Building Height"
for category in os.listdir(base_folder):
    if category in ["Building", "Building Height"]:
        continue
...
output_folder = "output/high_resolution_images"
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
